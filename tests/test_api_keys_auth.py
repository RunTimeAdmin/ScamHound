...
def test_generate_api_key_rejects_cross_account_for_non_admin(fastapi_test_client):
...
def test_generate_api_key_defaults_to_authenticated_user_email(fastapi_test_client):
